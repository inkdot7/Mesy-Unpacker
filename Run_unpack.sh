...
# 4-> Uses the Interpreter.py script to create a configuration file from the .mvlclst (Mesytec file)
# 5-> Uses the Unpacker and the configuration file to translate .mvlclst to .root (Mesytec file)
